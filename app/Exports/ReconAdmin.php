...
use App\Exports\Sheets\ReconTemplateAdmin;
...
class ReconAdmin implements WithMultipleSheets
{
    /**
    ...
    public function sheets(): array
    {
        ...
        for($y = 0; $y < count($this->user_cat); $y++){
            // for($x = 0; $x < count($this->recon_details); $x++){
                $sheets[] = new ReconTemplateAdmin($this->date, $this->recon_details[$this->user_cat[$y]], $this->user_cat[$y], $this->rec_to, $this->rec_from);
            // }
        }
